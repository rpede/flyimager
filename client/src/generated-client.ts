...
> extends HttpClient<SecurityDataType> {
  ...
  upload = {
     ...
     * @tags Upload
     * @name UploadDetail
     * @request GET:/Upload/{key}
     */
    uploadDetail: (key: string, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/Upload/${key}`,
        method: "GET",
        ...params,
     ...
     * @tags Upload
     * @name UploadDelete
     * @request DELETE:/Upload/{key}
     */
    uploadDelete: (key: string, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/Upload/${key}`,
        method: "DELETE",
        ...params,
     ...
     * @request GET:/Upload/attachment/{key}
     */
    attachmentDetail: (key: string, params: RequestParams = {}) =>
      this.request<void, any>({
        path: `/Upload/attachment/${key}`,
        method: "GET",
        ...params,
      }),
  };
